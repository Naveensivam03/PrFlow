...
public class ComplexityCalculator {
  ...
  public ComplexityBreakdown calculate(int totalFilesChanged, int totalAdditions, int totalDeletions,
    ...
    double diffScore = (fileCountScore * config.getWeights().getFileCountInDiff()) +
    ...
    double finalScore = (diffScore * config.getWeights().getDiffV1()) +
